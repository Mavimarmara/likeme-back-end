 ...
 * /api/amazon/search:
 *   get:
 *     summary: Search Amazon products by keywords (web scraping)
 *     tags: [Amazon]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: Search keywords (e.g., "yoga mat", "protein powder")
 *     responses:
 *       200:
 *         description: Amazon products retrieved successfully from search page
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *       500:
 *         description: Error searching products from Amazon page
 */
